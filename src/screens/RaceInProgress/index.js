...
@inject("RaceInProgressStore", "LocationStore")
@observer
export default class RaceInProgressScreen extends Component {
  ...
  componentWillMount() {
    this.props.RaceInProgressStore.getRaceInProgress();
  }
  ...
  render() {
    const {
      ...
      getRaceInProgress,
      dataWasChanged
    } = this.props.RaceInProgressStore;
    const {
  ...
  componentDidUpdate() {
    this.props.RaceInProgressStore.closeFlag();
  }
}
